...
export const createEntry = function (tablename, entryObj) {
    return new Promise((resolve, reject) => {
        console.log('creatre',entryObj);
        dbcon()(tablename).insert(entryObj).then((result) => resolve(result)).catch((error) => {
...
export const searchEntry = function (queryfield, queryvalue) {
    switch (queryfield) {
        ...
        case 'PATIENT_PREGNANCY':
            return new Promise((resolve, reject) => dbcon()('PATIENT_PREGNANCY')
                .select({ patientId: 'PATIENT_PREGNANCY.patient' }, 'PATIENT_PREGNANCY.startDate', 'PATIENT_PREGNANCY_DATA.date','PATIENT_PREGNANCY_IMAGING.date')
                .leftOuterJoin('PATIENT_PREGNANCY_DATA', 'PATIENT_PREGNANCY_DATA.pregnancyId', 'PATIENT_PREGNANCY.id')
                .leftOuterJoin('PATIENT_PREGNANCY_IMAGING', 'PATIENT_PREGNANCY_IMAGING.pregnancyDataId', 'PATIENT_PREGNANCY_DATA.id')
                .where('PATIENT_PREGNANCY.patient', '=', `%${queryvalue}%`)
